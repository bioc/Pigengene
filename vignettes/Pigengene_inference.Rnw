...
<<loading,fig=TRUE, fig.width=6, fig.height=6, eigengenesecho=TRUE>>=
library(Pigengene)
data(aml)
data(mds)
d1 <- rbind(aml,mds)
...
%%
<<tree, fig=TRUE, fig.width=5, fig.height=5, echo=TRUE>>=
...
%%
<<pigengene, fig=TRUE, fig.width=5, fig.height=5, echo=TRUE>>=
...
<<citation, results='asis', print=TRUE, eval=TRUE>>=
citation("Pigengene")
@ 
