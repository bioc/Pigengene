...
The first step is to load the package and data in

<<oneStepTest, echo=TRUE>>=
at1 <- 1+4
@
...
##library(Pigengene)
##@
<<loading4, fig.width=6, fig.height=6, echo=TRUE>>=
data(aml)
data(mds)
@
<<loading3, fig.width=6, fig.height=6, echo=TRUE>>=
d1 <- rbind(aml,mds)
@
